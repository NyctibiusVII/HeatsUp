...
export default class MyDocument extends Document {
    render() {
        const
            ...
            description = 'Projeto web construído durante o NLW#07 com a Rocketseat/Diego Fernandes, Daniele Leão, Rodrigo Gonçalves e Rafael Camarda. HEATSUP: "Chat de aquecimento pré evento". 🤩💬🤸‍♀️',
            keywords    = 'nodejs, sass, html, typescript, reactjs, nextjs, impulse, heatsup, projeto, contexts, rocketseat, vercel, nextlevelweek, diegofernandes, danieleleão, rodrigogonçalves e rafaelcamarda, nlw7, trilha-impulse'
        ...
        return (
            <Html lang='pt-BR'>
                <Head>
                    ...
                    <meta name='description'  content='Chat de aquecimento pré evento. 🤩💬🤸‍♀️' />
                    ...
                    <link rel='shortcut icon' href='/logo/logo-heatsup-round.png' type='image/png' />
